...
export const IconSettings = ({ size = 24, className }: { size?: number, className?: string }) => (
...
export const IconPlay = ({ size = 24, className }: { size?: number, className?: string }) => (
...
export const IconPause = ({ size = 24, className }: { size?: number, className?: string }) => (
...
export const IconRefresh = ({ size = 24, className }: { size?: number, className?: string }) => (
...
export const IconClose = ({ size = 24, className }: { size?: number, className?: string }) => (
...
export const IconMagnet = ({ size = 24, className }: { size?: number, className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m6 15-4-4 6.75-6.77a7.79 7.79 0 0 1 11 11L13 22l-4-4 6.39-6.39a4.5 4.5 0 0 0-6.36-6.36L2.25 12" /><path d="m5 8 4 4" /></svg>
);
export const IconRepel = ({ size = 24, className }: { size?: number, className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><circle cx="12" cy="12" r="10"/><path d="m4.93 4.93 14.14 14.14"/></svg>
);